...
async function buildUpdate(req, res, next) {
  ...
  const person = `${itemData[0].account_firstname}`
  res.render("account/update-account", {
    title: "Update Account Information of " + person,
    nav,
...
module.exports = { buildLogin, buildRegister, buildManagement, buildUpdate, registerAccount, accountLogin }